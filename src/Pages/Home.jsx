    ...
    <div>
        <div className='relative h-screen bg-cover bg-center'
            ...
            <div className='absolute inset-0 flex flex-col items-center justify-center'>
                <div>
                    <img src = {kamo} className='w-40 rounded-lg shadow-violet-600 mb-10 mt-20'></img>
                </div>
                <h1 className='text-4xl md:text-6xl font-bold text-white mb-6'>Hey there, I'm a frontend software developer</h1>
                <p className='text-xl md:text-2xl text-white mb-20'>Browse through, I guarantee you'll find something you like.</p>
                <div>
                <Link to = '/projects'>
